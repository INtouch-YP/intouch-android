...
import care.intouch.uikit.ui.textFields.TextFieldDefault.BLANC_STRING
...
fun OneLineTextField(
    ...
    Column(
        modifier = modifier.width(TextFieldDefault.MinWidth)
    ) {
        Text(
...
fun TextInputPreview() {
    InTouchTheme {
        Surface(color = InTouchTheme.colors.mainColorBlue) {
